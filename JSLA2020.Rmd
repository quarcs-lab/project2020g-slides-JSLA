...
date: "Prepared for the 57th Annual Conference of JSLA <br /><br />[ slides available at: https://felipe-santos.rbind.io/]"
output:
...
- Policy development and management should consider not only current challenges but also the potential values in the near future.
...
- To create a simple forecasting model that can predict homicide rates 4-years into the future.
...
Therefore, a plausible 4-year ahead forecast can be:
...
(Spatially Lagged X) is proposed to forecast homicide**, the spatial equivalent
...
Where three coefficients need to be forecasted $\alpha$, $\beta$ and $\theta$.
...
The linear regressions are used to compute the coefficients in:
...
- In terms of homicides the baseline for 2018 is 25.8(per 100.000 people) and
...
**regions in dark green are lagging behind**
...
- For example, there is a clear negative spill-over in the municipalities in **the pacific region**.
...
If you are interested in (my) our research please check our QuaRCS lab website <br />
